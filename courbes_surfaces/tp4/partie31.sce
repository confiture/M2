// surface de B�zier triangulaire
// d�finition de la B�zier triangulaire par ses points de controle
// P{i,j,k}=(X{i,j,k},Y{i,j,k},Z{i,j,k}) et poids W{i,j,k}
// sous forme de 4 tableaux (vecteurs-ligne) X, Y, Z et W 
// avec (n+1)*(n+2)/2 �l�ments (n �tant le degr� de la B�zier)
// les �l�m�nts d'indices {i,j,k} sont stock�s ainsi :
//   element{n,0,0} 
//   element{n-1,1,0} 
//   ...
//   element{1,n-1,0}
...
// definir le degr� n puis 
// 4 tableaux X,Y,Z et W de longueur (n+1)*(n+2)/2

// exemple de surface de degr� 3
n=3;// degr�
...
// n*n triangles :
// d�finir S le tableau des sommets � partir de X,Y,Z
...
// contenant les points de controle en coordonn�es homog�nes 
// de la B�zier rationnelle rectangulaire �quivalente
...
// ------------ 5 ------------   
// �criture de la B�zier rectangulaire rationnelle
//
...
// � un polygone de controle de degr� n
// Entr�e : P = tableau des n points de controle
...
// Entr�e : S, T = tableaux d�crivant la triangulation
//          c = une couleur au format RGB : c = (r,g,b)
//              avec r,g et b trois r�els entre 0 et 1
