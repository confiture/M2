...
// a) r�cup�rer les programmes sources sur le site http://www.qhull.org
// b) compiler les programmes
//    -> ex�cutables qhull qvoronoi rbox qconvex qdelaunay qhalf
// Seul le programme ex�cutable qdelaunay est utilis� dans ce script
/////////////////////////////////////////////////////////////////////////////

/////////////////////////////////////////////////////////////////////////////
// r�cup�rer la date actuelle sous forme d'un chaine de caractere
...
/////////////////////////////////////////////////////////////////////////////
// calcul du centre de la sphere circonscrite � une d-cellule de R^d
...
// Entr�e : S = tableau des nS sommets 
...
//               l'indi�age fait r�f�rence au tableau S et commence � 1
//          C = centre des sph�res circonscrites aux cellules
//               matrice de nT lignes et d colonnes 
//               une ligne = les d coordonnees d'un centre
//          r = rayon des sph�res circonscrites aux cellules
//               vecteur de nT r�els
function [T,C,r] = delaunay(S)
  ...
  // �criture du tableau de sommets dans le fichier nom_fichier_sommets
...
function test_delaunay(num_test)
  ...
  // trac� de la triangulation de Delaunay
  scf();
  dessin_delaunay(S,T);
  
  // trac� des centres des cercles circonscrits
  plot(C(:,1),C(:,2),'g+');
  
  // trac� des cercles circonscrits  
  ...
  dessin_delaunay(S,T);
    ...
    case 3 then
  //// test 3 - points suivant une grille r�guli�re
  S = zeros(100,2);
  for i=0:9
    for j=1:10
      S(i*10+j,:)=[2*j+i 2*i];
  ...
  //// test 4 - points entr�s � la souris
  S = inputpoints()';
  [T,C] = delaunay(S);
