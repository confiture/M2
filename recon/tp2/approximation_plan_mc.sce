...
function main(num_test)
  ...
  //points de données provenant de la sphere unité
  n = 1000;
...
// calcul du plan approchant au sens des moindres carrés une nuage de points 
// Entree : x,y,z = coordonnées des points de données (vecteurs de n valeurs)
// Sortie : B,u,v,n = repère orthonormé local au plan
//            B : barycentre des points
//            u,v : vecteurs générateurs du plan
//            n : normale au plan
